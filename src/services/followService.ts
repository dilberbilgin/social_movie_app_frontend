...
export const followService = {
  ...
  unfollow: async (followingId: string): Promise<RestResponse<void>> => {
    ...
    getFollowers: async (userId: string): Promise<RestResponse<UserResponse[]>> => {
    const response = await api.get<RestResponse<UserResponse[]>>(`/follows/${userId}/followers`);
    return response.data;
  },
    getFollowing: async (userId: string): Promise<RestResponse<UserResponse[]>> => {
    const response = await api.get<RestResponse<UserResponse[]>>(`/follows/${userId}/following`);
    return response.data;
  },
